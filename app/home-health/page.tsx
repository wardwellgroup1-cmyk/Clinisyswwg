      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
          ...
          <section>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-3">Primary Diagnosis</label>
              <select
          ...
          <section>
            ...
            <textarea
              ...
              placeholder="e.g., Post-discharge care, medication management, wound care"
              rows={4}
              className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </section>
          ...
          <div className="flex gap-4 pt-6 border-t border-slate-200">
            <button className="flex-1 bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 font-medium">
              Generate Referral
            </button>
          </div>
        </div>
