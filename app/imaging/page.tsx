          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-md p-8 space-y-6">
            ...
            <section>
              ...
              <textarea
                ...
                placeholder="This imaging study is medically necessary to evaluate the patient's documented condition..."
                rows={4}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
              ...
              <ul className="text-sm text-purple-800 space-y-2">
                <li>• Include specific ICD-10 codes</li>
                <li>• Reference clinical guidelines</li>
                <li>• Explain medical necessity</li>
                <li>• Document clinical decision-making impact</li>
              </ul>
            </div>
          </div>
        </div>
